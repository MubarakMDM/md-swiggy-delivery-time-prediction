...
import dagshub
dagshub.init(repo_owner='md93150', repo_name='md-swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/md93150/md-swiggy-delivery-time-prediction.mlflow")
